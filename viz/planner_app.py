...
DARK_BG, PANEL_BG = "#0f0f23", "#1a1a2e"
...
def _legend():
    ...
    for lab, d in stimuli.LABEL_DEF.items():
        items.append(html.Div([
            ...
            html.Span(f"{lab} — {d['name']}", style={"fontSize": "12px", "color": "#ccc"}),
...
def _stimulus_grid():
    ...
    for sp in stimuli.STIM_SPECIES:
        cells = [html.Td(sp, style={"color": "#ccc", "fontWeight": "bold", "padding": "6px"})]
...
def _partition_table():
    ...
    header = [html.Th("Run", style={"padding": "6px", "color": "#aaa"})] + [
    ...
    for run in stimuli.RUNS:
        cells = [html.Td(run, style={"padding": "6px", "color": "#ccc",
...
app.layout = html.Div(style={"backgroundColor": DARK_BG, "color": "white", "minHeight": "100vh",
    ...
    html.H2("Analysis Planner", style={"textAlign": "center", "margin": "4px 0 10px", "color": "#e0e0ff"}),

    html.Div(style={"backgroundColor": PANEL_BG, "borderRadius": "8px", "padding": "12px 16px",
                    "marginBottom": "10px"}, children=[
        html.H4("EmoC stimulus conditions", style={"margin": "0 0 8px", "color": "#e0e0ff"}),
    ...
    html.Div(style={"backgroundColor": PANEL_BG, "borderRadius": "8px", "padding": "12px 16px",
                    "marginBottom": "10px"}, children=[
        html.H4("Partition design", style={"margin": "0 0 4px", "color": "#e0e0ff"}),
    ...
    html.Div(style={"backgroundColor": PANEL_BG, "borderRadius": "8px", "padding": "12px 16px"}, children=[
        html.H4("Design an analysis", style={"margin": "0 0 6px", "color": "#e0e0ff"}),
